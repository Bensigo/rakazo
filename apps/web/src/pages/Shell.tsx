    ...
    <div data-testid="bot-settings">
      ...
      <details data-testid="bot-settings-advanced" className="group mt-5">
        <summary className="flex cursor-pointer list-none items-center justify-between gap-3 text-[14px] text-[#85858A]">
          <span className="text-[#85858A]">{uiCopy("Advanced")}</span>
        ...
        {thinkingOptions.length ? (
          <label className="mt-4 block text-[14px] text-[#85858A]">
            ...
            <select
              ...
              className="mt-2 w-full rounded-[11px] border border-[#26262A] bg-transparent px-3.5 py-3 text-[#ECECEE]"
            >
              <option value="">{uiCopy("Default (medium)")}</option>
...
function thinkingLevelLabel(level: ThinkingLevel) {
  switch (level) {
    case "off":
      return uiCopy("Off");
    case "minimal":
      return uiCopy("Minimal");
    case "low":
      return uiCopy("Low");
    case "medium":
      return uiCopy("Medium");
    case "high":
      return uiCopy("High");
    case "xhigh":
      return uiCopy("Extra high");
    case "max":
      return uiCopy("Max");
  }
}
