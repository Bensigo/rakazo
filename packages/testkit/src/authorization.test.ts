...
describeWithDatabase("API authorization and resource isolation", () => {
  ...
  it("rejects unauthenticated calls to every protected RPC family", async () => {
    const calls = exhaustiveProtectedCalls([
      ...
      ["studio/foundation"],
      ["studio/publishFoundation", { content: { mission: "Nope" } }],
      ["studio/projects"],
      ["studio/createProject", { name: "Nope", slug: "nope", scope: "one" }],
      ["studio/roles"],
      [
        "studio/createRole",
        {
      ...
      ["studio/acceptAssignment", { assignmentId: "missing-assignment" }],
      ["bots/list"],
      ["bots/listArchived"],
